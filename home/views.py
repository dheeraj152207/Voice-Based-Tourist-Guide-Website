...
def home(request):
    ...
    beach = beach1.count()
    context = {'dests':param,'explore':explore,'comment':comment, 'prev':prev, 'nxt':nxt, 'page':page, 'charam':charam, 'tour':tour, 'rural':rural, 'cultural':cultural,         'adventure':adventure, 'beach':beach, 'karam':karam}
